...
CREATE TABLE `pedidos` (
  ...
  `codPedido` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
INSERT INTO `pedidos` (`idPedido`,`total`,`fecha`,`estado`,`idCliente`,`codPedido`) VALUES 
 (1,328.000,'2015-12-18 00:00:00','Recibido',1,0x4D532D323031352D303030303031),
 (2,659.000,'2015-12-21 00:00:00','Enviado',1,0x4D532D323031352D303030303032),
 (3,1597.400,'2016-01-02 00:00:00','Pendiente',1,0x4D532D323031362D303030303031),
 (4,1335.500,'2016-01-02 00:00:00','Recibido',5,0x43422D323031362D303030303031),
 (5,2.400,'2016-01-04 00:00:00','Enviado',5,0x43422E323031362D303030303032);
...
CREATE TABLE `productos` (
  ...
  KEY `productos_ibfk_1` (`idCategoria`,`idSubcategoria`),
  CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`idCategoria`, `idSubcategoria`) REFERENCES `subcategorias` (`idCategoria`, `idSubcategoria`)
...
INSERT INTO `userdetail` (`id`,`name`,`username`,`password`,`idCliente`) VALUES 
 (1,'Maria Anders','manders','12345',1),
 (2,'Ana Trujillo','atrujillo','12345',2),
 (3,'Antonio Moreno','amoreno','12345',3),
 (4,'Thomas Hardy','thardy','12345',4),
 (5,'Christina Berglund','cberglund','12345',5),
 (6,'Hanna Moos','hmoos','12345',6),
 (7,'Friderique Citeaux','fciteaux','12345',7),
 (8,'Martin Sommer','msommer','12345',8),
 (9,'Laurence Lebihan','llebihan','12345',9),
 (10,'Elizabeth Lincoln','elincoln','12345',10),
 (11,'Victoria Ashworth','vashworth','12345',11),
 (12,'Patricio Simpson','psimpson','12345',12),
 (13,'Francisco Chang','fchang','12345',13),
 (14,'Yang Wang','ywang','12345',14),
 (15,'Pedro Afonso','pafonso','12345',15),
 (16,'Elizabeth Brown','ebrown','12345',16),
 (17,'Sven Ottlieb','sottlieb','12345',17),
 (18,'Janine Labrune','jlabrune','12345',18),
 (19,'Ann Devon','adevon','12345',19),
 (20,'Roland Mendel','rmendel','12345',20),
 (21,'Aria Cruz','acruz','12345',21),
 (22,'Diego Roel','droel','12345',22),
 (23,'Martine Rance','mrance','12345',23),
 (24,'Maria Larsson','mlarsson','12345',24),
 (25,'Peter Franken','pfranken','12345',25),
 (26,'Carine Schmitt','cschmitt','12345',26),
 (27,'Paolo Accorti','paccorti','12345',27),
 (28,'Lino Rodriguez','lrodriguez','12345',28),
 (29,'Eduardo Saavedra','esaavedra','12345',29),
 (30,'Jose Pedro','jpedro','12345',30),
 (31,'Andres Fonseca','afonseca','12345',31),
 (32,'Howard Snyder','hsnyder','12345',32),
 (33,'Manuel Pereira','mpereira','12345',33),
 (34,'Mario Pontes','mpontes','12345',34),
 (35,'Carlos Hernandez','chernandez','12345',35),
 (36,'Yoshi Latimer','ylatimer','12345',36),
 (37,'Patricia McKenna','pmckenna','12345',37),
 (38,'Helen Bennett','hbennett','12345',38),
 (39,'Philip Cramer','pcramer','12345',39),
 (40,'Daniel Tonini','dtonini','12345',40),
 (41,'Annette Roulet','aroulet','12345',41),
 (42,'Yoshi Tannamuri','ytannamuri','12345',42),
 (43,'John Steel','jsteel','12345',43),
 (44,'Renate Messner','rmessner','12345',44),
 (45,'Jaime Yorres','jyorres','12345',45),
 (46,'Carlos Gonzales','cgonzales','12345',46),
 (47,'Felipe Izquierdo','fizquierdo','12345',47),
 (48,'Fran Wilson','fwilson','12345',48),
 (49,'Giovanni Rovelli','grovelli','12345',49),
 (50,'Catherine Dewey','cdewey','12345',50),
 (51,'Jean Dobua','jdobua','12345',51),
 (52,'Alexander Feuer','afeuer','12345',52),
 (53,'Simon Crowther','scrowther','12345',53),
 (54,'Yvonne Moncada','ymoncada','12345',54),
 (55,'Rene Phillips','rphillips','12345',55),
 (56,'Henriette Pfalzheim','hpfalzheim','12345',56),
 (57,'Marie Bertrand','mbertrand','12345',57),
 (58,'Guillermo Fernandez','gfernandez','12345',58),
 (59,'Georg Pipps','gpipps','12345',59),
 (60,'Isabel Suarez','isuarez','12345',60),
 (61,'Bernardo Batista','bbatista','12345',61),
 (62,'Lucia Carvalho','lcarvalho','12345',62),
 (63,'Horst Kloss','hkloss','12345',63),
 (64,'Sergio Gutierrez','sgutierrez','12345',64),
 (65,'Paula Wilson','pwilson','12345',65),
 (66,'Maurizio Moroni','mmoroni','12345',66),
 (67,'Janete Limeira','jlimeira','12345',67),
 (68,'Michael Holz','mholz','12345',68),
 (69,'Alejandra Camino','acamino','12345',69),
 (70,'Jonas Bergulfsen','jbergulfsen','12345',70),
 (71,'Jose Pavarotti','jpavarotti','12345',71),
 (72,'Hari Kumar','hkumar','12345',72),
 (73,'Jytte Petersen','jpetersen','12345',73),
 (74,'Dominique Perrier','dperrier','12345',74),
 (75,'Art Braunschweiger','abraunschweiger','12345',75),
 (76,'Pascale Cartrain','pcartrain','12345',76),
 (77,'Liz Nixon','lnixon','12345',77),
 (78,'Liu Wong','lwong','12345',78),
 (79,'Karin Josephs','kjosephs','12345',79),
 (80,'Miguel Angel','mangel','12345',80),
 (81,'Anabela Dominguez','adominguez','12345',81),
 (82,'Helvetius Nagy','hnagy','12345',82),
 (83,'Palle Ibsen','pibsen','12345',83),
 (84,'Mary Saveley','msaveley','12345',84),
 (85,'Paul Henriot','phenriot','12345',85),
 (86,'Rita Miller','rmiller','12345',86),
 (87,'Pirkko Koskitalo','pkoskitalo','12345',87),
 (88,'Paula Parente','pparente','12345',88),
 (89,'Karl Jablonski','kjablonski','12345',89),
 (90,'Matti Karttunen','mkarttunen','12345',90),
 (91,'Zbyszek Piestrzeniewicz','zpiestrzeniewicz','12345',91);
...
) ENGINE=InnoDB AUTO_INCREMENT=11078 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AVG_ROW_LENGTH=83;
