...
public class CatalogoPedidos 
{
	...
	//ATRIBUTOS
	private Collection<datos.OLD.Pedido> pedidos;
	
	
	//CONSTRUCTOR
	public CatalogoPedidos() 
	{
		this.pedidos = new ArrayList<datos.OLD.Pedido>();
		this.obtenerPedidos();
	}
	...
	//GETTER & SETTERS
	public Collection<datos.OLD.Pedido> getPedidos() 
	{
		return pedidos;
	}


	public void setPedidos(Collection<datos.OLD.Pedido> pedidos) 
	{
	...
	public Collection<datos.OLD.Pedido> obtenerPedidos()
	{
		...
		try
		{
			...
			{
				datos.OLD.Pedido p = new datos.OLD.Pedido();
