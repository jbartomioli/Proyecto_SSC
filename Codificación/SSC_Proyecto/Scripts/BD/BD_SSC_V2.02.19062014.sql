...
CREATE TABLE `anuncios` (
  `idAnuncio` INTEGER(11) NOT NULL AUTO_INCREMENT,
  `textoMensaje` LONGTEXT COLLATE utf8_spanish_ci,
...
AUTO_INCREMENT=75 AVG_ROW_LENGTH=936 CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci'
COMMENT=''
;
...
CREATE TABLE `categorias` (
  ...
  `descripcion` VARCHAR(50) COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY USING BTREE (`idCategoria`) COMMENT ''
)ENGINE=InnoDB
AUTO_INCREMENT=15 AVG_ROW_LENGTH=1092 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
CREATE TABLE `subcategorias` (
  ...
  `idSubcategoria` INTEGER(11) NOT NULL AUTO_INCREMENT,
  `descripcion` VARCHAR(50) COLLATE utf8_general_ci DEFAULT NULL,
...
AUTO_INCREMENT=24 AVG_ROW_LENGTH=138 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
CREATE TABLE `productos` (
  ...
  `codProducto` VARCHAR(8) COLLATE utf8_general_ci NOT NULL,
  ...
  UNIQUE INDEX `codProducto` USING BTREE (`codProducto`) COMMENT '',
   ...
   INDEX `productos_ibfk_1` USING BTREE (`idSubcategoria`, `idCategoria`) COMMENT '',
  CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`idSubcategoria`, `idCategoria`) REFERENCES `subcategorias` (`idCategoria`, `idSubcategoria`)
)ENGINE=InnoDB
AUTO_INCREMENT=902 AVG_ROW_LENGTH=95 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
CREATE TABLE `lineaDePedido` (
  ...
  PRIMARY KEY USING BTREE (`idLinea`, `idPedido`) COMMENT '',
...
CREATE TABLE `lineasDeVentas` (
  ...
  `idProducto` INTEGER(11) NOT NULL,
  PRIMARY KEY USING BTREE (`idLinea`, `idVenta`) COMMENT '',
...
AUTO_INCREMENT=2156 AVG_ROW_LENGTH=41 CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci'
COMMENT=''
;
...
CREATE TABLE `parametrosNegocio` (
  `idParametro` INTEGER(11) NOT NULL AUTO_INCREMENT,
  `membrete` VARCHAR(500) COLLATE utf8_general_ci DEFAULT NULL,
  `ultIdPedido` INTEGER(11) DEFAULT NULL,
  PRIMARY KEY USING BTREE (`idParametro`) COMMENT ''
)ENGINE=InnoDB
AUTO_INCREMENT=2 AVG_ROW_LENGTH=16384 ROW_FORMAT=DYNAMIC CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
CREATE TABLE `precios` (
  ...
  `idProducto` INTEGER(11) NOT NULL DEFAULT 0,
  ...
  PRIMARY KEY USING BTREE (`idPrecio`, `idProducto`) COMMENT '',
   INDEX `idProducto` USING BTREE (`idProducto`) COMMENT '',
...
AVG_ROW_LENGTH=202 CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci'
COMMENT=''
;

#
# Data for the `anuncios` table  (LIMIT -428,500)
#

INSERT INTO `anuncios` (`idAnuncio`, `textoMensaje`, `fecha`, `estado`, `membrete`) VALUES

  (1,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--prueba-->','2014-06-02 19:14:05','PENDIENTE',''),
  (2,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--aaaaa-->','2014-06-02 19:31:49','PENDIENTE',''),
  (3,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA KLEPP TOPICAL        </td>        <td>          $ 30.5        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--probando-->','2014-06-02 19:38:59','PENDIENTE',''),
  (4,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--7-->','2014-06-02 19:43:57','PENDIENTE',''),
  (5,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--3-->','2014-06-02 19:57:44','PENDIENTE',''),
  (6,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--3-->','2014-06-02 22:32:42','PENDIENTE',''),
  (7,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--77777777777-->','2014-06-02 22:35:30','PENDIENTE',''),
  (8,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--c-->','2014-06-02 23:06:10','PENDIENTE',''),
  (9,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--cdcd-->','2014-06-02 23:26:49','PENDIENTE',''),
  (10,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA ANESCART FORTR X50.        </td>        <td>          $ 84.8        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--cdcddcdcdcdc-->','2014-06-02 23:35:47','PENDIENTE',''),
  (11,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--pppppppppp-->','2014-06-02 23:38:30','PENDIENTE',''),
  (12,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA ANESCART FORTR X50.        </td>        <td>          $ 84.8        </td>      </tr>      <tr>        <td>          ANESTESIA KLEPP TOPICAL        </td>        <td>          $ 30.5        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--vvv-->','2014-06-02 23:43:42','PENDIENTE',''),
  (13,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--probando probando-->','2014-06-04 19:15:58','PENDIENTE',''),
  (14,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--probando-->','2014-06-04 19:24:47','PENDIENTE',''),
  (15,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          XYLOCAINA DENTSPLY X 50        </td>        <td>          $ 62.8        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq-->','2014-06-04 19:29:09','PENDIENTE',''),
  (17,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--probando-->','2014-06-04 19:34:21','PENDIENTE',''),
  (18,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--probando-->','2014-06-04 19:35:50','PENDIENTE',''),
  (19,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          XYLOCAINA DENTSPLY X 50        </td>        <td>          $ 62.8        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--wwwwwwwwwwwwwwwwwwwww-->','2014-06-04 19:39:11','PENDIENTE',''),
  (20,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          XYLOCAINA DENTSPLY X 50        </td>        <td>          $ 62.8        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--q-->','2014-06-04 19:45:50','PENDIENTE',''),
  (21,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--ooooooooooo-->','2014-06-04 19:51:40','PENDIENTE',''),
  (22,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          XYLOCAINA DENTSPLY X 50        </td>        <td>          $ 62.8        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--aaaaaaaaaaaaaaaaaaa-->','2014-06-04 19:56:47','PENDIENTE',''),
  (23,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ALGODON EN ROLLOS X 2        </td>        <td>          $ 4.0        </td>      </tr>      <tr>        <td>          CONOS DENTSPLY        </td>        <td>          $ 19.5        </td>      </tr>      <tr>        <td>          CONOS ACCESORIOS DMG        </td>        <td>          $ 21.0        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--probando-->    <!--Promos-->','2014-06-04 21:13:07','PENDIENTE',''),
  (24,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--aaaaaaaaa-->','2014-06-04 21:40:23','PENDIENTE',''),
  (25,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--8888888888888-->','2014-06-04 21:42:53','PENDIENTE',''),
  (26,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--6666666666666-->','2014-06-04 21:45:32','PENDIENTE',''),
  (27,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          XYLOCAINA DENTSPLY X 50        </td>        <td>          $ 62.8        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--qqqqqqqqqqqqqqq-->','2014-06-04 21:47:03','PENDIENTE',''),
  (28,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA MUCO-ANESTYL GEL 50G        </td>        <td>          $ 20.1        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--10000000000000-->','2014-06-04 21:52:29','PENDIENTE',''),
  (29,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--555555555-->','2014-06-04 23:22:03','PENDIENTE',''),
  (30,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--25555555555-->','2014-06-04 23:25:57','PENDIENTE',''),
  (31,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA SPRAY INDICAN        </td>        <td>          $ 22.0        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--+9999999999999-->','2014-06-04 23:27:24','PENDIENTE',''),
  (32,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--999999999-->','2014-06-04 23:29:19','PENDIENTE',''),
  (33,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--llllllll-->','2014-06-04 23:32:28','PENDIENTE',''),
  (34,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA TOTALCAINA X 50        </td>        <td>          $ 93.6        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--99999999999-->','2014-06-04 23:37:11','PENDIENTE',''),
  (35,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--pru-->','2014-06-05 17:27:44','PENDIENTE',''),
  (36,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--sssssssss-->','2014-06-05 17:43:39','PENDIENTE',''),
  (37,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--aaaaaaaaaaaaaaa-->','2014-06-05 17:47:25','PENDIENTE',''),
  (39,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--uuuuuuuuuuuuuuu-->','2014-06-05 18:04:00','PENDIENTE',''),
  (40,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          XYLOCAINA DENTSPLY X 50        </td>        <td>          $ 62.8        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--aaaaaaaaaaaaaaaaaa-->','2014-06-05 18:21:38','PENDIENTE',''),
  (41,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--aaaaaaaaa-->','2014-06-05 18:28:16','PENDIENTE',''),
  (42,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          XYLOCAINA DENTSPLY X 50        </td>        <td>          $ 62.8        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--Malbec-->','2014-06-05 18:44:44','PENDIENTE',''),
  (44,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--limado...-->','2014-06-05 19:03:39','PENDIENTE',''),
  (45,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--´ññññññññññññññññññññññññññññññ-->','2014-06-05 19:07:24','PENDIENTE',''),
  (46,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA TOTALCAINA X 50        </td>        <td>          $ 93.6        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--aaaaaaaaaaaa-->','2014-06-05 20:14:31','PENDIENTE',''),
  (47,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--ssssssssssss-->','2014-06-05 20:24:21','PENDIENTE',''),
  (48,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ALGODON EN ROLLOS X 2        </td>        <td>          $ 4.0        </td>      </tr>      <tr>        <td>          CONOS DENTSPLY        </td>        <td>          $ 19.5        </td>      </tr>      <tr>        <td>          CONOS ACCESORIOS DMG        </td>        <td>          $ 21.0        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--ddddddddddd-->    <!--Promos-->','2014-06-05 20:43:14','PENDIENTE',''),
  (49,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ALGODON EN ROLLOS X 2        </td>        <td>          $ 4.0        </td>      </tr>      <tr>        <td>          CONOS DENTSPLY        </td>        <td>          $ 19.5        </td>      </tr>      <tr>        <td>          CONOS ACCESORIOS DMG        </td>        <td>          $ 21.0        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--aaaaaaaa-->    <!--Promos-->','2014-06-05 21:36:36','PENDIENTE',''),
  (50,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA TOTALCAINA X 50        </td>        <td>          $ 93.6        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--ihgib-->','2014-06-05 21:43:25','PENDIENTE',''),
  (51,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA TOTALCAINA X 50        </td>        <td>          $ 93.6        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--aaaa-->','2014-06-05 21:50:32','PENDIENTE',''),
  (52,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA TOTALCAINA X 50        </td>        <td>          $ 93.6        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--694684-->','2014-06-05 21:58:14','PENDIENTE',''),
  (53,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA SPRAY INDICAN        </td>        <td>          $ 22.0        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--7857ki58k-->','2014-06-05 22:12:00','PENDIENTE',''),
  (54,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--assaf-->','2014-06-06 22:30:18','PENDIENTE',''),
  (55,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA SCANDONEST 3% S.V.C.        </td>        <td>          $ 73.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--wrdcfvgbhnjk-->','2014-06-06 22:35:38','PENDIENTE',''),
  (56,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA TOTALCAINA X 50        </td>        <td>          $ 93.6        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--rynsrynarynanarn-->','2014-06-06 22:47:21','PENDIENTE',''),
  (57,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA TOTALCAINA X 50        </td>        <td>          $ 93.6        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--wergthyo-->','2014-06-07 09:05:07','PENDIENTE',''),
  (58,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA SCANDONEST 3% S.V.C.        </td>        <td>          $ 73.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--enEnhenj-->','2014-06-07 09:29:43','PENDIENTE',''),
  (59,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA SPRAY INDICAN        </td>        <td>          $ 22.0        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--ynen-->','2014-06-07 15:32:08','PENDIENTE',''),
  (60,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA MUCO-ANESTYL GEL 50G        </td>        <td>          $ 20.1        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--rtfhyumjk-->','2014-06-07 15:36:09','PENDIENTE',''),
  (61,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA SPRAY INDICAN        </td>        <td>          $ 22.0        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--gbgb-->','2014-06-07 15:37:51','PENDIENTE',''),
  (62,'<h1>  T&#237;tulo del anuncio</h1><p>  P&#225;rrafo 1</p><table>  <tr><th>  Producto</th><th>  Precio Vigente</th>  </tr>  <tr><td>  ALGODON EN ROLLOS X 2</td><td>  $ 4.0</td>  </tr>  <tr><td>  CONOS DENTSPLY</td><td>  $ 19.5</td>  </tr>  <tr><td>  CONOS ACCESORIOS DMG</td><td>  $ 21.0</td>  </tr></table><p>  P&#225;rrafo 2</p><!--sssssssss--><!--Promos-->','2014-06-09 20:06:22','PENDIENTE',''),
  (63,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA MUCO-ANESTYL GEL 50G        </td>        <td>          $ 20.1        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--9856-->    <!--9856-->','2014-06-09 20:21:06','PENDIENTE',''),
  (64,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ALGODON EN ROLLOS X 2        </td>        <td>          $ 4.0        </td>      </tr>      <tr>        <td>          CONOS DENTSPLY        </td>        <td>          $ 19.5        </td>      </tr>      <tr>        <td>          CONOS ACCESORIOS DMG        </td>        <td>          $ 21.0        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--werdtfhyukm-->    <!--Promos-->','2014-06-09 23:21:33','PENDIENTE',''),
  (65,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA SPRAY INDICAN        </td>        <td>          $ 22.0        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--mnyjthbgrvfcedxsa-->','2014-06-09 23:30:04','PENDIENTE',''),
  (66,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA SPRAY INDICAN        </td>        <td>          $ 22.0        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--,muyjnhbtgvrf-->','2014-06-09 23:33:21','PENDIENTE',''),
  (67,'<h1>  T&#237;tulo del anuncio</h1><p>  P&#225;rrafo 1</p><table>  <tr><th>  Producto</th><th>  Precio Vigente</th>  </tr>  <tr><td>  XYLOCAINA DENTSPLY X 50</td><td>  $ 62.8</td>  </tr></table><p>  P&#225;rrafo 2</p><!--AAAAwwww-->','2014-06-11 18:46:53','PENDIENTE',''),
  (68,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA TOTALCAINA X 50        </td>        <td>          $ 93.6        </td>      </tr>      <tr>        <td>          XYLOCAINA DENTSPLY X 50        </td>        <td>          $ 62.8        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--hgvfcdxs-->','2014-06-11 20:21:08','PENDIENTE',''),
  (69,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA TOTALCAINA X 50        </td>        <td>          $ 93.6        </td>      </tr>      <tr>        <td>          XYLOCAINA DENTSPLY X 50        </td>        <td>          $ 62.8        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--jhgfd-->','2014-06-11 20:24:56','PENDIENTE',''),
  (70,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          INDICAN GEL        </td>        <td>          $ 23.2        </td>      </tr>      <tr>        <td>          XYLOCAINA DENTSPLY X 50        </td>        <td>          $ 62.8        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--Probando-->','2014-06-11 22:52:40','PENDIENTE',''),
  (71,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          <div>            ANESTESIA KLEPP TOPICAL          </div>          <div>            <img src=\"file:C:\\Documents and Settings\\All Users\\Documentos\\Mis imágenes\\Imágenes de muestra\\Invierno.jpg\">                      </div>        </td>        <td>          $ 30.5        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--w4gvsd-->','2014-06-11 23:05:08','PENDIENTE',''),
  (72,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ARCO NITI CUADRADO        </td>        <td>          $ 5.8        </td>      </tr>      <tr>        <td>          CAJA ACERO 17 X 7 X 3        </td>        <td>          $ 32.4        </td>      </tr>      <tr>        <td>          ESTERILIZADORA CUARZO DRILLCO        </td>        <td>          $ 451.4        </td>      </tr>      <tr>        <td>          DESINF. GLUTARCOAT A.S.        </td>        <td>          $ 22.4        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--asdfghj-->','2014-06-12 08:20:32','PENDIENTE',''),
  (73,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA SCANDONEST 3% S.V.C.        </td>        <td>          $ 73.2        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>  <!--wasdcfvgbnhjmk-->','2014-06-12 21:51:22','PENDIENTE',''),
  (74,'<h1>      T&#237;tulo del anuncio    </h1>    <p>      P&#225;rrafo 1    </p>    <table>      <tr>        <th>          Producto        </th>        <th>          Precio Vigente        </th>      </tr>      <tr>        <td>          ANESTESIA SPRAY INDICAN<img src=\"file:C:\\Documents and Settings\\All Users\\Documentos\\Mis imágenes\\Imágenes de muestra\\Nenúfares.jpg\">        </td>        <td>          $ 22.0        </td>      </tr>      <tr>        <td>          <div>            ANESTESIA TOTALCAINA X 50          </div>          <div>            <img src=\"file:C:\\Documents and Settings\\All Users\\Documentos\\Mis imágenes\\Imágenes de muestra\\Puesta de sol.jpg\">                      </div>        </td>        <td>          $ 93.6        </td>      </tr>    </table>    <p>      P&#225;rrafo 2    </p>    <!--zsxdcgfbh-->','2014-06-13 08:07:18','PENDIENTE','');

#
# Data for the `categorias` table  (LIMIT -485,500)
#
...
INSERT INTO `clientes` (`idCliente`, `nombre`, `apellido`, `email`, `especialidad`, `tipo`, `direccion`, `telefono`) VALUES
  ...
  (4,'Thomas','Hardy','javierbartomioli@gmail.com','Gnatología',1,'120 Hanover Sq.','(171) 555-7788'),
  (5,'Christina','Berglund','javierbartomioli@gmail.com','Gnatología',1,'Watson 1300','0921-12 34 65'),
  (6,'Hanna','Moos','javierbartomioli@gmail.com','Gnatología',1,'Forsterstr. 57','0621-08460'),
  (7,'Friderique','Citeaux','javierbartomioli@gmail.com','Endodoncia',1,'Sherlo Holmes 1256','88.60.15.31'),
  (8,'Martin','Sommer','javierbartomioli@gmail.com','Gnatología',1,'C/ Araquil, 67','(91) 555 22 82'),
  ...
  (44,'Renate','Messner','jbartom@hotmail.com','Ortodoncista',1,'Magazinweg 7','069-0245984'),
  ...
  (48,'Fran','Wilson','jbartom@hotmail.com','Ortodoncista',1,'89 Chiaroscuro Rd.','(503) 555-9573'),
  (49,'Giovanni','Rovelli','jbartom@hotmail.com','Endodoncia',1,'Via Ludovico il Moro 22','035-640230'),
  (50,'Catherine','Dewey','jbartom@hotmail.com','Ortodoncista',1,'Rue Joseph-Bens 532','(02) 201 24 67'),
  ...
  (53,'Simon','Crowther','rnaredo_4@hotmail.com','Ortodoncista',1,'South House 300 Queensbridge','(171) 555-7733'),
  (54,'Yvonne','Moncada','rnaredo_4@hotmail.com','Ortodoncista',1,'Ing. Gustavo Moncada 8585 Piso 20-A','(1) 135-5333'),
  (55,'Rene','Phillips','rnaredo_4@hotmail.com','Ortodoncista',1,'2743 Bering St.','(907) 555-7584'),
  ...
  (58,'Guillermo','Fernandez','rnaredo_4@hotmail.com','Ortodoncista',1,'Calle Dr. Jorge Cash 321','(5) 552-3745'),
  (59,'Georg','Pipps','rnaredo_4@hotmail.com','Ortodoncista',1,'Geislweg 14','6562-9722'),
  (60,'Isabel','Suarez','rnaredo_4@hotmail.com','Ortodoncista',1,'Jean Paul Sartre 679','(1) 356-5634'),
  ...
  (64,'Sergio','Gutierrez','rnaredo_4@hotmail.com','Ortodoncista',1,'Av. del Libertador 900','(1) 123-5555'),
  (65,'Paula','Wilson','rnaredo_4@hotmail.com','Ortodoncista',1,'2817 Milton Dr.','(505) 555-5939'),
  (66,'Maurizio','Moroni','rnaredo_4@hotmail.com','Ortodoncista',1,'Strada Provinciale 124','0522-556721'),
  (67,'Janete','Limeira','rnaredo_4@hotmail.com','Ortodoncista',1,'Av. Copacabana, 267','(21) 555-3412'),
  (68,'Michael','Holz','rnaredo_4@hotmail.com','Ortodoncista',1,'Grenzacherweg 237','0897-034214'),
  ...
  (71,'Jose','Pavarotti','rnaredo_4@hotmail.com','Ortodoncista',1,'187 Suffolk Ln.','(208) 555-8097'),
  (72,'Hari','Kumar','rnaredo_4@hotmail.com','Ortodoncista',1,'90 Wadhurst Rd.','(171) 555-1717'),
  ...
  (75,'Art','Braunschweiger','rnaredo_4@hotmail.com','Ortodoncista',1,'P.O. Box 555','(307) 555-4680'),
  ...
  (81,'Anabela','Dominguez','sscproyecto@gmail.com','Ortodoncista',1,'Av. San Martin 1988','(11) 555-2167'),
  (82,'Helvetius','Nagy','sscproyecto@gmail.com','Ortodoncista',1,'722 DaVinci Blvd.','(206) 555-8257'),
  (83,'Palle','Ibsen','sscproyecto@gmail.com','Ortodoncista',1,'Smagsloget 45','86 21 32 43'),
  (84,'Mary','Saveley','sscproyecto@gmail.com','Ortodoncista',1,'2, rue du Commerce','78.32.54.86'),
  (85,'Paul','Henriot','sscproyecto@gmail.com','Protesista',1,'59 rue de l''Abbaye','26.47.15.10'),
  (86,'Rita','Miller','sscproyecto@gmail.com','Ortodoncista',1,'Adenauerallee 900','0711-020361'),
  (87,'Pirkko','Koskitalo','sscproyecto@gmail.com','Protesista',1,'Torikatu 38','981-443655'),
  (88,'Paula','Parente','sscproyecto@gmail.com','Ortodoncista',1,'Rua do Mercado, 12','(14) 555-8122'),
  (89,'Karl','Jablonski','sscproyecto@gmail.com','Odontologia General',1,'305 - 14th Ave. S. Suite 3B','(206) 555-4112'),
  (90,'Matti','Karttunen','sscproyecto@gmail.com','Ortodoncista',1,'Keskuskatu 45','90-224 8858'),
...
#
# Data for the `parametrosNegocio` table  (LIMIT -498,500)
#
...
#
# Data for the `productos_anuncios` table  (LIMIT -418,500)
#
