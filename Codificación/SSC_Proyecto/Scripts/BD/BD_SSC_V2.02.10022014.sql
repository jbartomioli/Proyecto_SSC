...
--
-- Servidor: localhost
-- Tiempo de generación: 10-02-2014 a las 14:51:56
...
CREATE TABLE IF NOT EXISTS `lineasDeVentas` (
  ...
  KEY `idProducto` (`idProducto`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AVG_ROW_LENGTH=41 AUTO_INCREMENT=2156 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=95 AUTO_INCREMENT=902 ;
...
(47, '219', 'HOJAS BISTURI N¥15 IMPORTADAS', 199, 1, 2),
(48, 'A219', 'HOJAS DE BISTURI N¥ 15 XINDA', 499, 1, 2),
...
(133, 'A1082', 'JERINGA AELITE POSTERIOR', 431, 5, 3),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=138 AUTO_INCREMENT=24 ;
...
ALTER TABLE `productos`
  ADD CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`idSubcategoria`, `idCategoria`) REFERENCES `subcategorias` (`idCategoria`, `idSubcategoria`);
