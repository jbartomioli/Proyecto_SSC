...
static final String URL_BD = "http://bartomserver.sytes.net:"+PORT+"/"+DATABASE;

// default query retrieves all data from authors table
//static final String DEFAULT_QUERY = "SELECT * FROM clientes";
static final String DEFAULT_QUERY =  "SELECT CONCAT(c.nombre,' ',c.apellido) AS nombre, "+
		"p.codProducto, " +
		"p.nombre, " +
		"lv.cantidad " +
		"FROM productos p " +
		"INNER JOIN lineasDeVentas lv " +
		"ON p.idProducto = lv.idProducto " +
		"INNER JOIN ventas v " +
...
{   
   ...
   try 
   {
      ...
      tableModel = new ResultSetTableModel( CONTROLADOR, URL_BD, USER, PASS, DEFAULT_QUERY );
